"""
ReconForge v5.0 — Report Generator
...
def save_txt(results, path):
    ...
    lines += [
        div,
        "  RECONFORGE v5.0 — ATTACK SURFACE REPORT",
        div,
    ]
...
<div class="footer">Generated by <strong style="color:#00ff88">ReconForge v5.0</strong> — For authorized security assessments only</div>
</body></html>"""
